...
WHERE dt="2022-02-02"
GROUP BY 1,2,3,B_MixName_Adj,B_MixCode_Adj,B_NumRGUs,B_MaxStart,B_MRC,B_Avg_MRC
)
,ActiveUsersEOM AS(
...
GROUP BY 1,2,3,E_MixName_Adj,E_MixCode_Adj,E_NumRGUs,E_MaxStart,E_MRC,E_Avg_MRC
)
,CustomerStatus AS(
  SELECT DISTINCT
