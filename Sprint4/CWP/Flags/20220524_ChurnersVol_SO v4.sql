...
,CASE WHEN DXtype='Involuntario' AND FixedChurnFlag='2. Fixed NonChurner' THEN 1 ELSE 0 END AS earlydxflag
...
select distinct *
from invFlagso
where fixedmonth=date('2022-02-01') AND earlydxflag=1
