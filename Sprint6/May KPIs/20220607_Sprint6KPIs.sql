WITH FMC_Table AS
( select distinct month, B_Final_TechFlag, B_FMCSegment, B_FMCType,E_Final_TechFlag, E_FMCSegment, E_FMCType,b_final_tenure,e_final_tenure,B_FixedTenure,E_FixedTenure,finalchurnflag,fixedchurnflag,fixedmainmovement,waterfall_flag,finalaccount,fixedaccount
  FROM "lla_cco_int_stg"."cwp_sp3_basekpis_dashboardinput_dinamico_rj_v3_mayo"
)
...
,Final_Fields AS(
select distinct month, B_Final_TechFlag, B_FMCSegment, B_FMCType,E_Final_TechFlag, E_FMCSegment,E_FMCType, b_final_tenure,e_final_tenure,B_FixedTenure,E_FixedTenure,finalchurnflag,fixedchurnflag,fixedmainmovement,waterfall_flag,InteractionsTier,TicketsTier,finalaccount,fixedaccount,interactions,tickets,numbertickets as PrevNumberTickets,recordsperuser,numbertickets/RecordsPerUser as NumberTickets,OutlierRepair
