...
from (select *,
        ...
        and date(dt) between (DATE('2022-03-01') + interval '1' MONTH - interval '1' DAY - interval '2' MONTH) AND  (DATE('2022-03-01') + interval '1' MONTH - interval '1' DAY)) 
)
...
where fixedmonth=date('2022-03-01')
