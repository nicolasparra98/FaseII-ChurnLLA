...
--GET
,MTTI as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'customer_time' as facet,'get' as journey_waypoint,'MTTI' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den from fmc_table)
,tinstall as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'NPW_detractorship' as facet,'get' as journey_waypoint,'tInstall' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den from fmc_table)
,ftr_installs as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'effectiveness' as facet,'get' as journey_waypoint,'%FTR_installs' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den from fmc_table)
,installs as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_drivers' as facet,'get' as journey_waypoint,'Installs' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den from fmc_table)
,selfinstalls as(
...
--support-Tech
,mttr as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'Customer_time' as facet,'support-tech' as journey_waypoint,'MTTR' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den from fmc_table)
,helprepair as(
...
,ftrrepair as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'effectiveness' as facet,'support-tech' as journey_waypoint,'%FTR_Repair' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den from fmc_table)
,justrepairs as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_drivers' as facet,'support-tech' as journey_waypoint,'Repairs' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den from fmc_table)
,repairs1k as(
