...
,ftth_join_coord as (
select distinct dt,provincias as provincia,distritos as distrito,corregimiento_ADJ as corregimiento,nodo,home_passed,longitude,latitude
...
select distinct date(b.dt) as Month,Provincia,Distrito,Corregimiento,acct_no,nodo,sum(home_passed) as home_passed
