...
--/*
select distinct month,Risk_Customer,count(distinct fixedaccount) as Total_Accounts,count(distinct vol_churner) as Churners,count(distinct non_vol_churner) as Non_Churners
from risk_flag
