CREATE TABLE IF NOT EXISTS "lla_cco_int_stg"."cwp_sp3_BASEKPIs_dashboardinput_dinamico_RJ_PruebaProdFeb" AS

WITH 

FixedConvergency AS(
 SELECT * 
 FROM "lla_cco_int_stg"."cwp_fix_stg_dashboardinput_dinamico_PruebaProdFeb"
 --"lla_cco_int_stg"."cwp_fix_stg_dashboardinput_dinamico_PruebaProd"
 --"lla_cco_int_stg"."cwp_fix_stg_dashboardinput_dinamico_July"
)
