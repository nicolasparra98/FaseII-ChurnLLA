...
,BillingCalls AS(
SELECT DISTINCT 
CONTRATO, FECHA_APERTURA AS FechaFact
...
FROM ConsultaFinal c INNER JOIN BillingCalls b ON c.ACT_ACCT_CD=b.Contrato
WHERE ((MONTH2_VS_MONTH1 = 'WENT DOWN'OR MONTH2_VS_MONTH1 = 'WENT UP') AND MONTH3_VS_MONTH2 IS NOT NULL)
OR ((MONTH3_VS_MONTH2 = 'WENT DOWN'OR MONTH3_VS_MONTH2 = 'WENT UP') AND MONTH2_VS_MONTH1 IS NOT NULL)
AND FechaFact <'2021-10-31' AND FechaFact>='2021-06-01'
