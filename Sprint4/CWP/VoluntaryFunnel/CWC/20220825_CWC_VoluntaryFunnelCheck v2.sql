...
select distinct month,pd_bb_prod_nm,count(distinct intents)
from dna d inner join voluntary_gap v on d.act_acct_cd=cast(intents as varchar) and month_dna=month
where cast(fi_outst_age as double)>120
