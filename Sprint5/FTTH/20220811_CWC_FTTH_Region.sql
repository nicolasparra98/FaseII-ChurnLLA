...
,Coordenates as(
select *
from "lla_cco_int_san"."cwc_ext_region_coord"
)
,ftth_adj as(
select f.*,longitude,latitude
from ftth_base f left join Coordenates c on f.region=c.region
)
