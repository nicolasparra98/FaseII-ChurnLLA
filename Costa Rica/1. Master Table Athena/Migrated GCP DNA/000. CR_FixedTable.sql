...
select distinct * --fixed_month,fixedchurntype,count(distinct fixed_account),sum(b_numrgus)
from finaltable
where activebom=1 and fixedchurntype='2.Involuntary Churner' and fixed_month=date('2022-03-01')
