...
SELECT distinct month,b_fmcsegment,b_fmctype,mobile_activebom,e_fmcsegment,e_fmctype,mobile_activeeom,count(distinct finalaccount)
from Final_flags
where month=date('2022-03-01')
and e_fmcsegment='P1 Mobile' or e_fmctype='MobileOnly'
