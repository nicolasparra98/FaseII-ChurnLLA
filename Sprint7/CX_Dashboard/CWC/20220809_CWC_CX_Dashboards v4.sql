...
,ecommerce as(
select distinct month,'CWC' as Opco, 'Jamaica' as Market,'Large' as MarketSize,'Fixed' as Product,'B2C' as Biz_Unit,'digital_shift' as facet,'buy' as journey_waypoint,'e-Commerce' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den, null as KPI_Sla, 'M-0' as kpi_delay_display,'OVERALL' as Network from fmc_table)
,tBuy as(
...
,frccare as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'effectiveness' as facet,'support-call' as journey_waypoint,kpi_name,kpi_meas,kpi_num,kpi_den,kpi_sla,Kpi_delay_display,Network from wanda_kpis where kpi_name='FRC_Care')
-------------------------Service Delivery--------------
,service_delivery as(
