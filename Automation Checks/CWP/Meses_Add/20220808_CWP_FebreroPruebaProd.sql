CREATE TABLE IF NOT EXISTS "lla_cco_int_stg"."cwp_fix_stg_dashboardinput_dinamico_PruebaProdFeb" AS
--"lla_cco_int_stg"."cwp_fix_stg_dashboardinput_dinamico_PruebaProd" AS
WITH
Convergente AS(
...
and date(dt) between (DATE('2022-02-01') + interval '1' MONTH - interval '1' DAY - interval '2' MONTH) AND  (DATE('2022-02-01') + interval '1' MONTH - interval '1' DAY + interval '2' MONTH)
