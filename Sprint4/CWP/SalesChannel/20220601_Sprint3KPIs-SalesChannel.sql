...
Group by 1,2,3,4,5, B_FMCTYPE, E_FMCTYPE,First_Sales_Chnl_EOM, First_sales_CHNL_BOM, Last_Sales_CHNL_EOM, Last_Sales_CHNL_BOM, SALES_CHANNEL,sales_channel_so
...
*/
SELECT DISTINCT Month,Sales_Channel,sum(monthsale_flag) as Sales,count(distinct F_SalesFlag) as Unique_Sales
FROM FullTable_Adj
WHERE Month=date('2022-02-01') --AND F_SalesFlag>0
--limit 10
