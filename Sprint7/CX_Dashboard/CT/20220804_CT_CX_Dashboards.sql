...
,GrossAdds_Flag as(
  ...
  count(distinct Gross_Adds) as kpi_meas,null as kpi_num,null as kpi_den,null as KPI_Sla,'M-0' as Kpi_delay_display,'OVERALL' as network from FMC_Table group by 1,2,3,4,5,6,7,8,9,15
)
,GrossAdds_Network as(
  select distinct Month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_drivers' as facet,'buy' as journey_waypoint,'Gross_Adds' as kpi_name,
  count(distinct Gross_Adds) as kpi_meas,null as kpi_num,null as kpi_den,null as KPI_Sla,'M-0' as Kpi_delay_display,Tech as network from FMC_Table group by 1,2,3,4,5,6,7,8,9,15
)
,ActiveBase_Flag1 as(
  ...
  count(distinct Active_Base) as kpi_meas,null as kpi_num,null as kpi_den,null as KPI_Sla,'M-0' as Kpi_delay_display,'OVERALL' as Network from FMC_Table group by 1,2,3,4,5,6,7,8,9,15
)
,ActiveBase_Flag2 as(
...
,ActiveBase_Network1 as(
  select distinct Month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_drivers' as facet,'use' as journey_waypoint,'Active_Base' as kpi_name,
  count(distinct Active_Base) as kpi_meas,null as kpi_num,null as kpi_den,null as KPI_Sla,'M-0' as Kpi_delay_display,Tech as Network from FMC_Table group by 1,2,3,4,5,6,7,8,9,15
)
