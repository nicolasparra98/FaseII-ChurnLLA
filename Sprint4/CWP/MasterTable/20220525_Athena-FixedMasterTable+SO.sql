--CREATE TABLE IF NOT EXISTS "lla_cco_int_stg"."cwp_fix_stg_dashboardinput_dinamico_RJ_v2" AS
WITH
Convergente AS(
...
--/*
select distinct FixedChurnType,FixedChurnSubtype,gap,count(distinct fixedaccount) as records
