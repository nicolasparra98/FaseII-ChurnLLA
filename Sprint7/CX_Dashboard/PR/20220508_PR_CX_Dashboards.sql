...
,cccare as(
select distinct  month,Opco,Market,MarketSize,Product,Biz_Unit,'customer_time' as facet,'support-call' as journey_waypoint,'CC_SL_Care' as kpi_name,kpi_meas,kpi_num,kpi_den,Kpi_delay_display,Network  from fmc_table)
,cctech as(
select distinct  month,Opco,Market,MarketSize,Product,Biz_Unit,'customer_time' as facet,'support-call' as journey_waypoint,'CC_SL_Tech' as kpi_name,kpi_meas,kpi_num,kpi_den,Kpi_delay_display,Network  from fmc_table)
,chatbot as(
select distinct  month,Opco,Market,MarketSize,Product,Biz_Unit,'digital_shift' as facet,'support-call' as journey_waypoint,'Chatbot_Containment_Care' as kpi_name,kpi_meas,kpi_num,kpi_den,Kpi_delay_display,Network from fmc_table)
,carecall as(
select distinct  month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_intensity' as facet,'support-call' as journey_waypoint,'Care_Calls_per_1k_RGU' as kpi_name,kpi_meas,kpi_num,kpi_den,Kpi_delay_display,Network from fmc_table)
,techcall as(
select distinct  month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_intensity' as facet,'support-call' as journey_waypoint,'Tech_Calls_per_1k_RGU' as kpi_name,kpi_meas,kpi_num,kpi_den,Kpi_delay_display,Network from fmc_table)
,chahtbottech as(
select distinct  month,Opco,Market,MarketSize,Product,Biz_Unit,'digital_shift' as facet,'support-tech' as journey_waypoint,'Chatbot_Containment_Tech' as kpi_name,kpi_meas,kpi_num,kpi_den,Kpi_delay_display,Network from fmc_table)
-------------------------------------Other Kpis-----------------------------------------------------
,highrisk as(
...
,ecommerce as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'digital_shift' as facet,'buy' as journey_waypoint,'%eCommerce' as kpi_name, kpi_meas, kpi_num,kpi_den, Kpi_delay_display, Network from fmc_table)
,frccare as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'effectiveness' as facet,'support-call' as journey_waypoint,'%FRC_Care' as kpi_name, kpi_meas, kpi_num,kpi_den, Kpi_delay_display, Network from fmc_table)
,ftr_billing as(
