...
,Classification AS(
SELECT l.act_acct_cd,l.Month,RGUSLast,RGUSFirst,
...
GROUP BY l.act_acct_cd,l.Month,RGUSLast,RGUSFirst
)
SELECT Month,SellFlag,COUNT(DISTINCT act_acct_cd) AS Records
FROM Classification
GROUP BY Month,SellFlag
