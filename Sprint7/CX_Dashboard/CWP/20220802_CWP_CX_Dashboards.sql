...
from Sprint3_KPIs group by 1 order by 1
)
...
,round(cast(sum(outlier_repairs) as double)/cast(sum(fixed_accounts) as double),4) as Breech_Cases_Repair
,round(cast(sum(numbertickets) as double)/cast(sum(fixed_accounts) as double),4) as Tech_Tix_per_100_Acct
from Sprint5_KPIs group by 1,2,3,4,5,6,7 order by 1,2,3,4,5,6,7
)
------------------------------------New KPIs--------------------------------------------------------------
,payments as(
...
-------Prev Calculated
,GrossAdds_Flag as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_drivers' as facet,'buy' as journey_waypoint,'Gross_Adds' as kpi_name,count(distinct Gross_Adds) as kpi_meas,0 as kpi_num,0 as kpi_den, 'M-0' as Kpi_delay_display,'OVERALL' as Network from fmc_table Group by 1,2,3,4,5,6,7,8,9 )
,GrossAdds_Network as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_drivers' as facet,'buy' as journey_waypoint,'Gross_Adds' as kpi_name,count(distinct Gross_Adds) as kpi_meas,0 as kpi_num,0 as kpi_den, 'M-0' as Kpi_delay_display,Tech as Network from fmc_table Group by 1,2,3,4,5,6,7,8,9,14 )
,ActiveBase_Flag1 as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_drivers' as facet,'use' as journey_waypoint,'Active_Base' as kpi_name,count(distinct Active_Base) as kpi_meas,0 as kpi_num,0 as kpi_den, 'M-0' as Kpi_delay_display,'OVERALL' as Network from fmc_table Group by 1,2,3,4,5,6,7,8,9 )
,ActiveBase_Flag2 as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_drivers' as facet,'support-call' as journey_waypoint,'Active_Base' as kpi_name,count(distinct Active_Base) as kpi_meas,0 as kpi_num,0 as kpi_den, 'M-0' as Kpi_delay_display,'OVERALL' as Network  from fmc_table Group by 1,2,3,4,5,6,7,8,9 )
,ActiveBase_Network1 as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_drivers' as facet,'use' as journey_waypoint,'Active_Base' as kpi_name,count(distinct Active_Base) as kpi_meas,0 as kpi_num,0 as kpi_den, 'M-0' as Kpi_delay_display,Tech as Network from fmc_table Group by 1,2,3,4,5,6,7,8,9,14)
,ActiveBase_Network2 as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'contact_drivers' as facet,'support-call' as journey_waypoint,'Active_Base' as kpi_name,count(distinct Active_Base) as kpi_meas,0 as kpi_num,0 as kpi_den, 'M-0' as Kpi_delay_display,Tech as Network  from fmc_table Group by 1,2,3,4,5,6,7,8,9,14)
,TechTickets_Flag as (
...
,tBuy as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'NPS_Detractorship' as facet,'buy' as journey_waypoint,'tBuy' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den, 'M-0' as Kpi_delay_display,'OVERALL' as Network from fmc_table)
,mttb as(
...
--GET
,tinstall as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'NPS_Detractorship' as facet,'get' as journey_waypoint,'tInstall' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den, 'M-0' as Kpi_delay_display,'OVERALL' as Network from service_delivery)
,selfinstalls as(
...
,tpay as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'NPS_Detractorship' as facet,'pay' as journey_waypoint,'tpay' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den, 'M-0' as Kpi_delay_display,'OVERALL' as Network from fmc_table)
,ftr_billing as(
...
--Support-call
,helpcare as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'NPS_Detractorship' as facet,'support-call' as journey_waypoint,'tHelp_Care' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den, 'M-0' as Kpi_delay_display,'OVERALL' as Network from fmc_table)
,frccare as(
...
--support-Tech
,helprepair as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'NPS_Detractorship' as facet,'support-tech' as journey_waypoint,'tHelp_repair' as kpi_name, null as kpi_meas, null as kpi_num,	null as kpi_den, 'M-0' as Kpi_delay_display,'OVERALL' as Network from fmc_table)
--use
,highrisk as(
...
,pnps as(
select distinct month,Opco,Market,MarketSize,Product,Biz_Unit,'NPS_Detractorship' as facet,'use' as journey_waypoint,'pNPS' as kpi_name, null as kpi_meas, null as kpi_num,null as kpi_den, 'M-0' as Kpi_delay_display,'OVERALL' as Network from fmc_table)
--Wanda Dashboard
,billbill as(
...
,rnps as(
select distinct  month,Opco,Market,MarketSize,Product,Biz_Unit,'NPS' as facet,'relationship' as journey_waypoint,'rNPS' as kpi_name, null as kpi_meas, null as kpi_num,null as kpi_den, 'M-0' as Kpi_delay_display,'OVERALL' as Network from fmc_table)
---------------------------------Join Flags-----------------------------------------------------------------
,Join_DNA_KPIs as(
select distinct *
...
select distinct Month,Opco,Market,MarketSize,Product,Biz_Unit,journey_waypoint,facet,kpi_name,kpi_meas,kpi_num,kpi_den,null as KPI_Sla, kpi_delay_display,Network,year(Month) as ref_year,month(month) as ref_mo
