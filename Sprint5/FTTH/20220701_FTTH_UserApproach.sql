...
select distinct month,final_bom_activeflag,final_eom_activeflag,f_activebom,f_activeeom,b_fixed_mrc,b_mixname_adj,b_mixcode_adj,e_fixed_mrc,e_mixname_adj,e_mixcode_adj,fixedmainmovement,fixedspinmovement,fixedchurnflag,fixedchurntype,fixedchurnsubtype,finalchurnflag,churntypefinalflag,b_fmctype,e_fmctype,b_fmcsegment,e_fmcsegment,b_total_mrc,e_total_mrc,partial_total_churnflag,waterfall_flag,b_final_techflag,e_final_techflag,ftth_user,BB_User,Atypical_FTTH,provincia,nodo,home_passed
